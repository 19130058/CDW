    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/signup/**","/api/login/**","/api/verification/**", "/swagger-ui/**","/swagger-resources/**",
                        ...
                        "/webjars/**")
                .permitAll()
                .antMatchers("/api/article/favorite/**","/api/article/unfavorite/**","/api/users/**")
                .hasAuthority("USER")
                .antMatchers( "/api/article/create","/api/category/create","/api/category/update","/category/delete/**","/api/article/favorite/**","/api/article/unfavorite/**","/api/users/**",
